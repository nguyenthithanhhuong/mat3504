...
public class UndirectedUnweightedGraph<V, E> implements GraphInterface<V, E> {
    ...
    public UndirectedUnweightedGraph(boolean directed, boolean weighted) {
    ...
    public boolean insertEdge(VertexInterface<V> u, VertexInterface<V> v, E x) {
        ...
        adjacencyMatrix[uIndex][vIndex] = new Edge(u, v, null);

        if (!isDirected()) {
            adjacencyMatrix[vIndex][uIndex] = new Edge(u, v, null);
        }
